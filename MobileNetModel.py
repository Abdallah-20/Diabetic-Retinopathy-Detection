...
def build_model(train_generator,valid_generator,traindf,weights):
    ...
    mcp = ModelCheckpoint('D:\Materials\Graduation Project\Models\MobileNet.h5')
...
evaluate_model('D:\Materials\Graduation Project\Models\MobileNet.h5', test_generator)
