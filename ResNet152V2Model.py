...
def build_model(train_generator,valid_generator,traindf,weights):
    ...
    mcp = ModelCheckpoint('D:\Materials\Graduation Project\Models\ResNet152V2.h5')
...
evaluate_model('D:\Materials\Graduation Project\Models\ResNet152V2.h5', test_generator)
